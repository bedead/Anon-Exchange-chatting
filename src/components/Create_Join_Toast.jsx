const Create_Join_Toast = ({handlecreateDialogOpen, handlejoinDialogOpen}) => {
    ...
    return (
        <div id="toast-message-cta" className="flex mx-auto md:absolute md:right-5 md:bottom-5 items-center max-w-xs p-2 md:p-4 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
            <div className="flex">
